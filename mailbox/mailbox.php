...
if (mysqli_num_rows($result) > 0) {
  ...
  while($row = mysqli_fetch_assoc($result)) {
    ...
    $Id = $row["ID"];
     $Email =$row["Email"];
     $profile = "<img src='image/".$row['image']."' >"; 
    }
} else {
  echo "0 results";
}
...
$USER = $_SESSION['use'];
 $sql = "SELECT `image` FROM `user` WHERE `UserName`= '$USER' ";
 //$result = mysqli_query($conn, $sql);
 //$row=mysqli_fetch_array($result)
   $img = mysqli_query($conn, $sql);
      ...
      if(empty($row['image'])){
        $dir_name = "../img/";
        $images = glob($dir_name."undraw_profile.svg");
        foreach($images as $image) {
         $profile = '<img src="'.$image.'" /><br />';
                                    } 
                            }
else{
...
<link rel='stylesheet prefetch' href='http://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css'>
 <div class="mail-box">
                  <aside class="sm-side">
                      <div class="user-head">
                          <a class="inbox-avatar" href="../userdetails.php">
                              <img  width="64" hieght="60" <?php echo $profile; ?>
                          </a>
                          <div class="user-name">
                              <h5><a href="#">ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;  <?php echo $Id ?></a></h5>
                              <span><a href="#">USERNAME&nbsp;:&nbsp;<?php echo $UserName ?></a></span><br/>
                               <span><a href="#">NAME&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;<?php echo $Name ?></a></span><br/>
                                <span><a href="#">EMAIL&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;<?php echo $Email ?></a></span>
                          </div>
                              ...
                              <div class="modal-dialog">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          <form role="form" class="form-horizontal" method="POST" action="../sendmail.php">
                                              <div class="form-group">
                                                  <label class="col-lg-2 control-label">To</label>
                                                  <div class="col-lg-10">
                                                      <input type="text" placeholder="" id="inputEmail1" class="form-control" name="To" required="required">
                                                  </div>
                                              </div>
                                              <div class="form-group">
                                                  <label class="col-lg-2 control-label">Cc / Bcc</label>
                                                  <div class="col-lg-10">
                                                      <input type="text" placeholder="" id="cc" class="form-control" name="Cc">
                                                  </div>
                                              </div>
                                              <div class="form-group">
                                                  <label class="col-lg-2 control-label">Subject</label>
                                                  <div class="col-lg-10">
                                                      <input type="text" placeholder="" id="inputPassword1" class="form-control" name="Subject" required="required">
                                                  </div>
                                              </div>
                                              <div class="form-group">
                                                  <label class="col-lg-2 control-label">Message</label>
                                                  <div class="col-lg-10">
                                                      <textarea rows="10" cols="30" class="form-control" id="" name="Message" required="required" ></textarea>
                                                  </div>
                                              </div>
                                              ...
                                              <div class="form-group">
                                                  <div class="col-lg-offset-2 col-lg-10">
                                                      <span class="btn green fileinput-button">
                                                        ...
                                                        <input type="file" name="files[]" multiple="" name="file">
                                                      </span>
                      ...
                      <div class="inbox-body text-center">
                          ...
                          <div class="btn-group">
                           <a class="btn mini btn-success" href="../index.php">
